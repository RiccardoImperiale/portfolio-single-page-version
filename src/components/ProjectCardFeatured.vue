...
<template>
  <div class="project_card" @mouseleave="isInfo = false">
    <div
      @mouseover="changeImageStyle(true)"
      @mouseleave="changeImageStyle(false)"
      class="btn_container"
    >
      <button
        class="btn"
        @mouseover="store.isCursorHidden = true"
      ...
      >
        ...
        <div class="btn_in">
          ...
          <a
            v-else
            :href="project.liveLink"
            class="text_left not_available"
            target="_blank"
            >Live Version</a
          >
          <a :href="project.sourceLink" class="text_right" target="_blank"
            >Source Code</a
          >
        </div>
      </button>
    ...
    <div
      :style="{ width: isInfo ? '110%' : '0' }"
      class="info_circle no_select"
    >
      <div class="info_text">
        <div class="title">
